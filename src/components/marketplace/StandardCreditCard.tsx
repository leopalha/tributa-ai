...
interface StandardCreditCardProps {
  credit: {
    id: string;
    title: string;
    description: string;
...
export function StandardCreditCard({
  credit,
  isFavorite = false,
  isWatching = false,
  onToggleFavorite,
  ...
  return (
    <Card className="hover:shadow-lg transition-all duration-200 h-full flex flex-col w-full max-w-sm">
      <CardHeader className="p-4 pb-2">
        ...
        {/* Imagem padronizada */}
        <div className="w-full h-48 bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg mb-3 flex items-center justify-center">
          {credit.images && credit.images.length > 0 ? (
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">Título de Crédito</p>
      ...
      <CardContent className="p-4 pt-0 flex-1 flex flex-col">
        {/* Descrição */}
        <p className="text-sm text-gray-600 line-clamp-2 mb-4">{credit.description}</p>
        ...
        {credit.category === 'auction' && credit.timeRemaining && (
        ...
        <div className="mt-auto space-y-2">
          {credit.category === 'buy_now' && (
            <Button onClick={handleBuyNow} className="w-full bg-green-600 hover:bg-green-700 h-10">
              <ShoppingCart className="w-4 h-4 mr-2" />
              Comprar Agora
            </Button>
          )}
          {credit.category === 'auction' && (
            <Button onClick={handlePlaceBid} className="w-full bg-blue-600 hover:bg-blue-700 h-10">
          ...
          <Button variant="outline" onClick={handleViewDetails} className="w-full h-10">
